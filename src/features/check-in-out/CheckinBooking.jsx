    ...
    return (
        <>
            ...
            {!hasBreakfast && <Box>
                ...
                }}>Do you want to add breakfast for {formatCurrency(optionalBreakfastPrice)}?</Checkbox>
            </Box>}
            <Box>
                <Checkbox id={'check-in'} disabled={confirmPaid || isCheckingIn} checked={confirmPaid}
                          onChange={() => setConfirmPaid(confirm => !confirm)}>I confirm
                    that {guests.fullName} has paid the total
                    amount {!addBreakfast ? formatCurrency(totalPrice) :
